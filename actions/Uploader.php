...
class Uploader
{
    ...
    public function __construct($fileField, $config, $type = "upload")
    {
        ...
        $this->stateMap['ERROR_TYPE_NOT_ALLOWED'] = $this->stateMap['ERROR_TYPE_NOT_ALLOWED']; //iconv('unicode', 'utf-8', $this->stateMap['ERROR_TYPE_NOT_ALLOWED']);
    }
    ...
    private function getFilePath()
    {
        ...
        /**
         * BEGIN PATCH 2014-07-20
         */
//        $rootPath = $_SERVER['DOCUMENT_ROOT'];
        $rootPath = isset($this->config['uploadBasePath']) ? $this->config['uploadBasePath'] : $_SERVER['DOCUMENT_ROOT'];
        /**
